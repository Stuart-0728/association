...
const NewActivity = {
  template: `<div class="container"><h1 class="mt-5">新建活动（开发中）</h1><p>这里是新建活动页面，请在此开发具体功能。</p></div>`
};
...
const routes = [
  ...
  { path: '/admin/activities/new', component: NewActivity }
];
